...
public enum Species {
    ...
    DUCK("Качка ", "\uD83E\uDD86", 1, 4, 100, 0.15, 1),
    GOAT("Коза ", "\uD83D\uDC10", 60, 3, 40, 10, 2),
    HAMSTER("Хомяк ", "\uD83D\uDC01", 0.05, 1, 100, 0.01, 1),
    HARE("Заяць ", "\uD83D\uDC07", 2, 2, 50, 0.45, 1.9),
    HORSE("Кінь ", "\uD83D\uDC0E", 400, 4, 20, 60, 30),
    BOAR("Кабан ", "\uD83D\uDC03", 400, 2, 50, 50, 25),
    SHEEP("Вівця ", "\uD83D\uDC11", 70, 3, 140, 15, 5),
    CATERPILLAR("Гусінь ", "\uD83D\uDC1B", 0.01, 0, 100, 0, 0),
